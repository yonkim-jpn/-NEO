<%@ Page Title="DB登録フォーム" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="DB_register.aspx.cs" Inherits="花騎士ツール＿NEO.DB_register" MaintainScrollPositionOnPostback="true" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid">
        <div>
            <asp:Label ID="Label50001" runat="server" Text="花騎士登録フォーム"></asp:Label>
            <asp:Button ID="Button50003" runat="server" OnClick="Button50003_Click" Text="入力クリア" />
        </div>
        <p>
