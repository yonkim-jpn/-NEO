...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        ...
        <p>花騎士のデータ登録は現在停止中です。登録に協力してくれる方いらっしゃいましたら<a href="javascript:void(0);"　target="_blank" onclick="window.open('https://twitter.com/chiyokanemaru/status/1229573710912221185?s=20','_blank')">Twitterアカウント</a>までご連絡下さい。
        現状の不十分な状態のまま花騎士のＷＥＢアプリを放置しておくのは来訪者様にもご迷惑であると考えています。
        しかるべきタイミングで花騎士のWEBアプリを削除致します。</p>
        <br />
